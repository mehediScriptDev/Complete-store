    ...
    <section className="mt-10">
      <div>
        <h1 className="text-3xl font-bold lg:text-4xl text-center">
            <span className="border-b-8 border-bidcl">Our</span> Experience
        </h1>
        <div className="mt-10 w-10/12 mx-auto grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 justify-items-center items-center gap-2 sm:gap-5 md:gap-6">

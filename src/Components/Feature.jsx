      ...
      <p className="text-bidcl text-xl font-bold  text-center">Best Choice</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 mt-10 ">
          ...
          >
            ...
            <p className="absolute bottom-6 left-5 text-2xl lg:text-4xl text-white/65 flex items-center gap-4">
          ...
          <Link to={"/dubai/visa"} className="relative">
            ...
            <p className="absolute bottom-6 left-5 text-2xl lg:text-3xl text-white/65 flex items-center gap-4">
              Request Now <FaArrowRightLong />
            </p>
          </Link>
